const TESTI_PREVISIONI = Object.freeze({
  ...
  en: {
    fattori: {
      ...
      andamentoScuderiaRecente: "Team performance in the last 3 Grands Prix",
  ...
  fr: {
    fattori: {
      ...
      andamentoScuderiaRecente: "Performance de l’écurie sur les 3 derniers Grands Prix",
  ...
  pt: {
    fattori: {
      ...
      andamentoScuderiaRecente: "Desempenho da equipa nos últimos 3 GP",
  ...
  es: {
    fattori: {
      ...
      andamentoScuderiaRecente: "Rendimiento del equipo en los últimos 3 GP",
  ...
  de: {
    fattori: {
      ...
      andamentoScuderiaRecente: "Teamleistung in den letzten 3 Grands Prix",
