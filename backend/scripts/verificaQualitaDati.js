...
const URL_ARCHIVIO_F1DB =
  "https://github.com/f1db/f1db/releases/download/v2026.14.0/f1db-json-splitted.zip";
...
richiedi(
  snapshotF1db.eventiStorici.length === 36 &&
    ...
    snapshotF1db.andamento2026.eventi.length === 14 &&
    snapshotF1db.calendario2026.passati.length === 14 &&
    snapshotF1db.calendario2026.prossimi.length === 9,
...
if (errori.length) {
  ...
  console.log(
    `OK qualità dati: ${valoriStoriciVerificati} risultati storici, ` +
      "34 classifiche e 14 GP 2026 coincidono con F1DB v2026.14.0; " +
